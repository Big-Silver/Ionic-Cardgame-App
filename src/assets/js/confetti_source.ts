...
class Confetti {
	...
	render(now) {
		...
		for (let i = 0; i < this.sprites.length; ++i) {
			...
			let translateX = this.sprites[i].position.initX + this.sprites[i].rotation * Confetti.CONST.ROTATION_RATE * progress;
			let translateY = (this.sprites[i].position.initY + progress * (this.height + this.yRange))*this.sprites[i].friction;
